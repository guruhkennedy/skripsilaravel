...
class PembatalanController extends Controller
{
    ...
    public function index(Request $request)
    {
        $pembatalans = Pembatalan::join('reservasi', 'pembatalan.id_reservasi', '=', 'reservasi.id')
            ...
            ->paginate(10);
        return view('karyawan.pembatalan.index', compact('pembatalans'));
    }
    ...
    public function terima(Request $request, Pembatalan $pembatalan)
    {
        ...
        return redirect()->route('karyawan.pembatalan.index')->with('success', 'Pembatalan Reservasi Berhasil Diterima');
    }
    ...
    public function tolak(Request $request, Pembatalan $pembatalan)
    {
        ...
        return redirect()->route('karyawan.pembatalan.index')->with('success', 'Pembatalan Reservasi Berhasil Ditolak');
    }
}
