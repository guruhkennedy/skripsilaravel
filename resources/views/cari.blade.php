...
@section('content')
    ...
    <section>
        <div class="container">
            ...
            @else
                <div class="text-center margin-50px-bottom xs-margin-30px-bottom">
                    <h3 class="margin-10px-bottom">Hasil Pencarian untuk tanggal : {{ \Carbon\Carbon::parse(request('date'))->translatedFormat('d F Y') }}</h3>
